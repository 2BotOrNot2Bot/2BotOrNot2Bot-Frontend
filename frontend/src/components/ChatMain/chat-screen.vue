...
<!--    bottom-->
    <div id="bottom" ref="bottom">
      ...
      <vs-input state="dark" v-model="inputMessage" :placeholder="canSend? 'Type in your message' : 'Please wait for new message :)'"/>
...
export default {
  ...
  methods: {
    ...
    startChat(chatterUid) {
      console.log(this.uid, chatterUid); // TODO haha
